(function() {
  ...
  Soup.prototype.disable = function() {
    if (this.box !== null) {
  ...
  Soup.prototype.activate = function() {
    if (this.box !== null) {
  ...
  Soup.prototype.setup = function(conf) {
    var THIS = this,
    ...
    function calcMatrix(vector, angle) {
      ...
      var x = vector[0],
        ...
        cos = Math.cos(angle),
        cosmin = 1 - cos,
        matrix = [(cos + x * x * cosmin), (y * x * cosmin + z * sin), (z * x * cosmin - y * sin), 0, (x * y * cosmin - z * sin), (cos + y * y * cosmin), (z * y * cosmin + x * sin), 0, (x * z * cosmin + y * sin), (y * z * cosmin - x * sin), (cos + z * z * cosmin), 0,
          0, 0, 0, 1
        ];
